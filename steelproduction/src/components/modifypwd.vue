    ...
    <div>
        <el-form class="formStyle1" :model="admininfo">
            ...
            <el-form-item label="管理员联系方式" class="fontcolor">
                <div class="forminput">
                    <!-- <el-input v-model="admininfo.name" placeholder="管 理 员 名 字"></el-input> -->
                    <p>{{admininfo.acontact}}</p>
                </div>
            </el-form-item>
    
            <el-form-item label="管理员权限级别" class="fontcolor">
                <div class="forminput">
                    <p v-if='admininfo.arole==0'>一般管理员</p>
                    <p v-if='admininfo.arole==1'>超级管理员</p>
                </div>
            </el-form-item>
        ...
        confirmmodify: function (formName) {
            ...
            this.$refs[formName].validate((valid) => {
                if (valid) {
                    ...
                    //     apwd: this.admininfo.apwd,
                    //     objtemp:this.admininfo
                    // };
                    this.$http.post('/sp/admin/modifyPwd',{ 
                        aid: this.admininfo.aid,
                        apwd: this.admininfo.apwd,
                        // objtemp:this.admininfo
                    }, {
