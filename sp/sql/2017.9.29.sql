...
CREATE TABLE `tb_material` (
  ...
  `M_PRICE` double(20,0) DEFAULT NULL COMMENT '材料单价',
...
-- ----------------------------
INSERT INTO `tb_material` VALUES ('05840891914211e7a3ecc85b76aeb963', '测试材料3', 'source', '21', '9913', '23', '0', '888', '88', '8', '1');
INSERT INTO `tb_material` VALUES ('07e4c9a7991d11e7acc0c85b76aeb963', '新材料', '来源地', '12', '200', '66', '1', '1', '1', '1', '1');
INSERT INTO `tb_material` VALUES ('6ab5756a9ab311e79724966435dcafda', '啊啊啊test', '来源地1', '43', '149', '155', '1', '14', '14', '14', '1');
INSERT INTO `tb_material` VALUES ('940a0242914111e7a3ecc85b76aeb963', '测试材料2', '这是来源地!', '13', '888', '233', '0', '100', '100', '101', '1');
INSERT INTO `tb_material` VALUES ('f3cad0698d6311e7b5cec85b76aeb963', '测试材料1', '来源地!!!!', '22', '321', '111', '1', '100', '10', '101', '1');
...
CREATE TABLE `tb_order_detail` (
  ...
  `DIAMETRE` double(20,0) DEFAULT NULL COMMENT '钢筋半径',
  `PRICE` double(20,0) DEFAULT NULL COMMENT '钢筋单价',
  `STEEL_CATEGORY` varchar(2) DEFAULT NULL COMMENT '钢筋种类',
  `PARTS_LENGTH` varchar(20) DEFAULT NULL COMMENT '部件长度',
  `LENGTH` double(20,0) DEFAULT NULL COMMENT '总长度',
  `COUNT` int(10) DEFAULT NULL COMMENT '数量',
  `WEIGHT` double(20,0) DEFAULT NULL COMMENT '重量',
  `TOTAL_PRICE` double(10,0) DEFAULT NULL COMMENT '总价',
  `STATE` varchar(2) DEFAULT '1' COMMENT '状态',
  PRIMARY KEY (`D_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tb_warehouse_record` (
  ...
  `PRICE` double(20,0) DEFAULT '0' COMMENT '入库单价',
...
-- ----------------------------
INSERT INTO `tb_warehouse_record` VALUES ('20e689c2-9b00-11e7-9724-966435dcafda', '6ab5756a9ab311e79724966435dcafda', '4', '1', '1', '0', '2017-09-17 00:57:31', '2017-09-17 00:57:31', '1');
INSERT INTO `tb_warehouse_record` VALUES ('40d82632-9ab0-11e7-9724-966435dcafda', '05840891914211e7a3ecc85b76aeb963', '1000', '0', '1', '1', '2017-09-16 15:25:45', '2017-09-16 15:26:44', '1');
INSERT INTO `tb_warehouse_record` VALUES ('45ee0cd8-9aae-11e7-9724-966435dcafda', '05840891914211e7a3ecc85b76aeb963', '12', '0', '1', '1', '2017-09-16 15:24:12', '2017-09-16 15:24:38', '1');
INSERT INTO `tb_warehouse_record` VALUES ('69850fd68ec811e7b5cec85b76aeb963', 'f3cad0698d6311e7b5cec85b76aeb963', '88888', '1', '1', '1', '2017-09-01 11:45:01', '2017-09-01 11:45:01', '1');
INSERT INTO `tb_warehouse_record` VALUES ('91c5f062-9c57-11e7-99f6-7f4d0226b51d', '6ab5756a9ab311e79724966435dcafda', '5', '1', '1', '1', '2017-09-18 17:55:57', '2017-09-24 00:01:53', '1');
INSERT INTO `tb_warehouse_record` VALUES ('a39f5ff88ebe11e7b5cec85b76aeb963', 'f3cad0698d6311e7b5cec85b76aeb963', '888', '1', '1', '0', '2017-09-01 10:35:03', '2017-09-01 13:28:53', '1');
INSERT INTO `tb_warehouse_record` VALUES ('b8b63759-9225-11e7-a3ec-c85b76aeb963', 'f3cad0698d6311e7b5cec85b76aeb963', '123456', '1', '1', '0', '2017-09-05 18:33:37', '2017-09-05 18:33:37', '1');
INSERT INTO `tb_warehouse_record` VALUES ('d87710a48ebd11e7b5cec85b76aeb963', 'f3cad0698d6311e7b5cec85b76aeb963', '888', '1', '1', '1', '2017-09-01 10:29:22', '2017-09-01 11:28:59', '1');
INSERT INTO `tb_warehouse_record` VALUES ('fa659bea8ec111e7b5cec85b76aeb963', 'f3cad0698d6311e7b5cec85b76aeb963', '888', '1', '1', '0', '2017-09-01 10:58:57', '2017-09-01 15:25:39', '1');
