...
CREATE TABLE `tb_order` (
  ...
  CONSTRAINT `FK_PRODUCT_PID` FOREIGN KEY (`P_ID`) REFERENCES `tb_product` (`P_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of tb_order
-- ----------------------------
INSERT INTO `tb_order` VALUES ('a04ad630921311e7a3ecc85b76aeb963', '测试项目111111', '3ea284418c6e11e7b5cec85b76aeb963', 'da44a3ce912411e7a3ecc85b76aeb963', '64c7f5eb87e311e7b5cec85b76aeb963', '3', '10', '2', '2017-09-10 16:24:04', '2017-09-05 16:24:04', '2017-09-05 16:24:04', '2', '1');
