...
import com.sp.net.utils.validate.ValidateUtils;
...
public class DateUtil extends org.apache.commons.lang3.time.DateUtils {
	...
	public static java.sql.Timestamp toSqlTimestamp(String sDate) {
		...
		return toSqlTimestamp(sDate, sDate.length() == DateUtil.DATE_FORMAT_DATEONLY.length() ? DateUtil.DATE_FORMAT_DATEONLY
